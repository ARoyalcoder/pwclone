...
const CourseDetail = () => {
    ...
    // Error state
    if (isError) {
        return <h1>Failed to load course details: {error?.message || "Unknown error"}</h1>
    }
    ...
    return (
        <div className='mt-20 space-y-5'>
            ...
            <div className='max-w-7xl mx-auto my-5 px-4 md:px-8 flex flex-col lg:flex-row justify-between'>
                <div className='w-full lg:w-1/2 space-y-5'>
                    <h1 className='font-bold text-xl md:text-3xl'>Description</h1>
                    <p className='font-semibold' dangerouslySetInnerHTML={{ __html: course?.description || "No description available." }} />
                ...
                {/* Video Player and Purchase Info */}
                <div className='w-full lg:w-1/3'>
                    <Card>
                        <CardContent className="p-4 flex flex-col">
